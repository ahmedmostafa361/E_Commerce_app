...
class _ApiServices implements ApiServices {
  ...
  Future<AddWhishListResponseDto> addToWhishList(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(productRequest.toJson());
    final _options = _setStreamType<AddWhishListResponseDto>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/v1/wishlist',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AddWhishListResponseDto _value;
    try {
      _value = AddWhishListResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<GetWhishListResponseDto> getWhishListItemsInCart(String token) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'token': token};
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetWhishListResponseDto>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/v1/wishlist',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GetWhishListResponseDto _value;
    try {
      _value = GetWhishListResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
